...
func kind(_ action: RTSPAction) -> String {
    switch action {
    case .send: "send"
...
func timerName(_ id: RTSPTimerID) -> String {
    switch id {
...
func errorName(_ error: RTSPError) -> String {
    switch error {
...
func stateName(_ state: RTSPSessionState) -> String {
    switch state {
    case .idle: "idle"
...
func kinds(_ actions: [RTSPAction]) -> [String] {
