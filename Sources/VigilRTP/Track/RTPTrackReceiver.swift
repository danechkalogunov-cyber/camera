...
public struct RTPTrackReceiver: Sendable {
    ...
    var frameTimestamps = TimestampUnwrapper()

    /// Unwraps sequence numbers, for the loss window and for diagnostics.
    var sequences = SequenceUnwrapper()
    ...
    /// Outbound RTCP.
    var reportBuilder: RTCPReportBuilder
    ...
    var idleFlushInterval: Duration {
        switch latency {
